...
namespace MVC
{
    public static class Views
    {
        ...
        {
            public static class CityDistrictList
            {
                public const string CityDistrictListIndex = "~/Modules/Mls/CityDistrictList/CityDistrictListIndex.cshtml";
            }

            public static class CityList
            {
                public const string CityListIndex = "~/Modules/Mls/CityList/CityListIndex.cshtml";
            }

            public static class CitySubAreaList
            {
                public const string CitySubAreaListIndex = "~/Modules/Mls/CitySubAreaList/CitySubAreaListIndex.cshtml";
            }

            public static class NeighborhoodList
            {
                public const string NeighborhoodListIndex = "~/Modules/Mls/NeighborhoodList/NeighborhoodListIndex.cshtml";
            }

            public static class RegionList
            {
                public const string RegionListIndex = "~/Modules/Mls/RegionList/RegionListIndex.cshtml";
            }

            public static class SurreyDeltaApartment2016Ytd
            {
                public const string SurreyDeltaApartment2016YtdIndex = "~/Modules/Mls/SurreyDeltaApartment2016Ytd/SurreyDeltaApartment2016YtdIndex.cshtml";
            }
